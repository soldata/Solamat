...
$report->setColumns( array(new PluginReportsColumnLink('rank_id',$LANG['plugin_resources'][77],'PluginResourcesRank',
                                                   array('sorton' => 'rank_name')),
                           new PluginReportsColumn('rank_code', $LANG['plugin_resources'][77]." - ".$LANG['plugin_resources'][30],
                                                   array('sorton' => 'rank_code')),
                           new PluginReportsColumnDate('rank_begin_date', $LANG['plugin_resources'][77]." - ".$LANG['plugin_resources'][34],
                                                   array('sorton' => 'rank_begin_date')),
                           new PluginReportsColumnDate('rank_end_date', $LANG['plugin_resources'][77]." - ".$LANG['plugin_resources'][35],
                                                   array('sorton' => 'rank_end_date')),
                           new PluginReportsColumnLink('prof_id',$LANG['plugin_resources'][80],'PluginResourcesProfession',
                                                   array('sorton' => 'prof_name')),
                           new PluginReportsColumn('prof_code', $LANG['plugin_resources'][80]." - ".$LANG['plugin_resources'][30],
                                                   array('sorton' => 'prof_code')),
                           new PluginReportsColumnDate('prof_begin_date', $LANG['plugin_resources'][80]." - ".$LANG['plugin_resources'][34],
                                                   array('sorton' => 'prof_begin_date')),
                           new PluginReportsColumnDate('prof_end_date', $LANG['plugin_resources'][80]." - ".$LANG['plugin_resources'][35],
