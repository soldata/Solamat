...
$datecrit = new PluginResourcesDateCriteria($report,'date_budget','',$LANG['plugin_resources']['title'][8]." - ".$LANG['common'][27]);
...
if ($report->criteriasValidated()) {
   ...
   if ($res && $nbtot >0) {
      ...
      showTitle($output_type, $num, $LANG['plugin_resources'][84], 'budget_type', true);
      showTitle($output_type, $num, $LANG['plugin_resources']['report'][2], 'qt_vol_budg_vot', true);
      showTitle($output_type, $num, $LANG['plugin_resources']['report'][3], 'qt_vol_budg_use');
      showTitle($output_type, $num, $LANG['plugin_resources']['report'][4], 'qt_vol_real');
      showTitle($output_type, $num, $LANG['plugin_resources']['report'][5], 'solde_qt');
      showTitle($output_type, $num, $LANG['plugin_resources']['report'][6], 'vol_budg_vot');
      showTitle($output_type, $num, $LANG['plugin_resources']['report'][7], 'vol_budg_use');
      showTitle($output_type, $num, $LANG['plugin_resources']['report'][8], 'vol_real');
      showTitle($output_type, $num, $LANG['plugin_resources']['report'][9], 'solde');
      ...
      echo Search::showItem($output_type, '', $num,$row_num);
      echo Search::showItem($output_type, '', $num,$row_num);
      echo Search::showItem($output_type, $LANG['plugin_resources']['report'][10]." - ".$LANG['plugin_resources']['report'][2], $num,$row_num);
      echo Search::showItem($output_type, $LANG['plugin_resources']['report'][10]." - ".$LANG['plugin_resources']['report'][3], $num,$row_num);
      echo Search::showItem($output_type, $LANG['plugin_resources']['report'][10]." - ".$LANG['plugin_resources']['report'][4], $num,$row_num);
      echo Search::showItem($output_type, '', $num,$row_num);
      echo Search::showItem($output_type, $LANG['plugin_resources']['report'][10]." - ".$LANG['plugin_resources']['report'][6],$num,$row_num);
      echo Search::showItem($output_type, $LANG['plugin_resources']['report'][10]." - ".$LANG['plugin_resources']['report'][7],$num,$row_num);
      echo Search::showItem($output_type, $LANG['plugin_resources']['report'][10]." - ".$LANG['plugin_resources']['report'][8],$num,$row_num);
      echo Search::showItem($output_type, $LANG['plugin_resources']['report'][10]." - ".$LANG['plugin_resources']['report'][9],$num,$row_num);
      echo Search::showEndLine($output_type);
