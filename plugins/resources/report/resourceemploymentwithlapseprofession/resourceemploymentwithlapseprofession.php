...
if ($nbtot >0) {
   ...
   showTitle($output_type, $num, $LANG['plugin_resources'][80]." - ".$LANG['plugin_resources'][34], 'begin_date', true);
   showTitle($output_type, $num, $LANG['plugin_resources'][80]." - ".$LANG['plugin_resources'][35], 'end_date', true);
   ...
   foreach($dataAll as $key=>$data){
      ...
      $profName = "<a href='".$link1."?id=".$data["profID"]."'>".$data["profession"]."</a>";
