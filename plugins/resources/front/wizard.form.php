...
/*if (isset($_POST["presentation"])) {
   ...
   unset($_SESSION["PluginResourcesSaved"]);
   
} else*/ if (isset($_POST["first_step"]) || isset($_GET["first_step"])) {
   
   if(!isset($_POST["template"])) $_POST["template"] = $_GET["template"];
   if(!isset($_POST["withtemplate"])) $_POST["withtemplate"] = $_GET["withtemplate"];
   ...
   $values['target'] = $_SERVER['HTTP_REFERER'];
   ...
   if(count($required) > 0) {
      ...
      echo "<div align='center'><b><span class='plugin_resources_date_over_color'>".
         $LANG['plugin_resources']['helpdesk'][6]."</span></b></div><br \>";
   ...
   if (isset($_FILES) && isset($_FILES['picture'])) {
      ...
      if ($_FILES['picture']['type']=="image/jpeg" || $_FILES['picture']['type']=="image/pjpeg") {
         $max_size=Toolbox::return_bytes_from_ini_vars(ini_get("upload_max_filesize"));
            ...
            echo "<div align='center'><b><span class='plugin_resources_date_over_color'>".
            $LANG['document'][46]."</span></b></div><br \>";
         }
      } else {
         echo "<div align='center'><b><span class='plugin_resources_date_over_color'>".
            $LANG['document'][44]. " : ".$_FILES['picture']['type']."</span></b></div><br \>";
      }
   }
