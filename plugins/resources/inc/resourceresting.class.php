...
class PluginResourcesResourceResting extends CommonDBTM {
   ...
   function prepareInputForAdd($input) {
      ...
      if (!isset ($input["date_begin"]) || $input["date_begin"] == 'NULL') {
         Session::addMessageAfterRedirect($LANG['plugin_resources']['helpdesk'][17], false, ERROR);
         return array ();
      }
   ...
   function post_addItem() {
		...
		Session::addMessageAfterRedirect($LANG['plugin_resources']['mailing'][34]);
   ...
   function post_updateItem($history=1) {
	...
	function getSearchOptions() {
      ...
      $tab[5]['name']=$LANG['plugin_resources']['helpdesk'][10];

      $tab[6]['table']=$this->getTable();
      $tab[6]['field']='at_home';
      $tab[6]['name']=$LANG['plugin_resources']['helpdesk'][11];
      $tab[6]['datatype']='bool';
   ...
   function showForm($ID, $options=array()) {
      ...
      echo "<div class='plugin_resources_presentation_logo'><img src='../pics/newresting.png' alt='newresting' /></div>";
      echo "</td>";

      echo "<td class='plugin_resources_wizard_right_area' style='width: 400px' valign='top'>";
      
      if ($ID > 0) {
         echo "<div class='plugin_resources_wizard_title'>".$LANG['plugin_resources']['helpdesk'][12]."</div>";
      } else {
         echo "<div class='plugin_resources_wizard_title'>".$LANG['plugin_resources']['helpdesk'][7]."</div>";
      }
      
      echo "<table>";
      echo "<tr class='plugin_resources_wizard_explain'><td>".$LANG['plugin_resources']['helpdesk'][9]." :</td>";
      ...
      echo "</td></tr>";
      echo "<tr class='plugin_resources_wizard_explain'><td>".$LANG['plugin_resources'][34]." :</td>";
      echo "<td class='left'>";
      Html::showDateFormItem("date_begin",$this->fields["date_begin"],true,true);
      echo "</td></tr>";
      echo "<tr class='plugin_resources_wizard_explain'><td>".$LANG['plugin_resources'][35]." :</td>";
      echo "<td class='left'>";
      Html::showDateFormItem("date_end",$this->fields["date_end"],true,true);
      echo "</td></tr>";
      echo "<tr class='plugin_resources_wizard_explain'><td>".$LANG['plugin_resources']['helpdesk'][10]." :</td>";
      echo "<td class='left'>";
      Dropdown::show('Location',
                  array('value'  => $this->fields["locations_id"]));
      echo "</td></tr>";
      echo "<tr class='plugin_resources_wizard_explain'><td>".$LANG['plugin_resources']['helpdesk'][11]." :</td>";
      echo "<td class='left'>";
      ...
      echo "<tr class='plugin_resources_wizard_explain'><td colspan='2'>".$LANG['common'][25].": </td></tr>";
      ...
      echo "<a href=\"./resourceresting.form.php\">".$LANG['plugin_resources']['helpdesk'][7]."</a>";
      echo "&nbsp;/&nbsp;<a href=\"./resourceresting.php\">".$LANG['plugin_resources']['helpdesk'][8]."</a>";
      echo "</div>";
      echo "<div class='next'>";
      if ($ID > 0) {
         echo "<input type='hidden' name='id' value='".$ID."' />";
         echo "<input type='hidden' name='plugin_resources_resources_id' value='".$this->fields["plugin_resources_resources_id"]."' />";
         echo "<input type='submit' name='updaterestingresources' value=\"".$LANG['plugin_resources']['helpdesk'][13]."\" class='submit' />";
         echo "&nbsp;&nbsp;<input type='submit' name='deleterestingresources' value=\"".$LANG['plugin_resources']['helpdesk'][14]."\" class='submit' />";
      } else {
         echo "<input type='submit' name='addrestingresources' value='".$LANG['plugin_resources']['helpdesk'][7]."' class='submit' />";
      }
      echo "</div>";
      echo "</td></tr></table>";
      Html::closeForm();
      ...
      if ($result = $DB->query($query)) {
         ...
         if ($p['start']<$numrows) {
            ...
            if ($output_type==PDF_OUTPUT_PORTRAIT|| $output_type==PDF_OUTPUT_LANDSCAPE) {
               $title.=$LANG['plugin_resources']['helpdesk'][8];
            }
