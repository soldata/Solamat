...
class PluginResourcesProfile extends CommonDBTM {
	...
	static function getTypeName() {
      ...
      return $LANG['plugin_resources']['profile'][0];
   }
   ...
   static function changeProfile() {
      ...
      if ($prof->getFromDBByProfile($_SESSION['glpiactiveprofile']['id'])) {
         ...
         $_SESSION['glpiactiveprofile']['helpdesk_item_type'][] = "PluginResourcesResource";
      } else {
         unset($_SESSION["glpi_plugin_resources_profile"]);
         unset($_SESSION["glpiactiveprofile"]['helpdesk_item_type']['PluginResourcesResource']);
      }
   }
	...
	function showForm ($ID, $options=array()) {
      ...
      $this->showFormHeader($options);
		...
		echo "<th colspan='4' class='center b'>".$LANG['plugin_resources']['profile'][0]." ".$prof->fields["name"]."</th>";

		echo "</tr>";
		echo "<tr class='tab_bg_2'>";

		echo "<td>".$LANG['plugin_resources']['profile'][1].":</td><td>";
		Profile::dropdownNoneReadWrite("resources",$this->fields["resources"],1,1,1);
		echo "</td>";

		echo "<td>".$LANG['plugin_resources']['title'][2].":</td><td>";
		...
		echo "<td>".$LANG['plugin_resources']['title'][3].":</td><td>";
		...
		echo "<td>".$LANG['plugin_resources']['profile'][9].":</td><td>";
		...
		echo "<td>".$LANG['plugin_resources']['profile'][7].":</td><td>";
		Profile::dropdownNoneReadWrite("all",$this->fields["all"],1,0,1);
		echo "</td>";

      echo "<td>" . $LANG['setup'][352] . " - " . $LANG['plugin_resources']['title'][1] . ":</td><td>";
      ...
      echo "<th colspan='4' class='center b'>".$LANG['plugin_resources']['profile'][2]."</th>";

      echo "</tr>";

      echo "<tr class='tab_bg_2'>";

      echo "<td>".$LANG['plugin_resources']['helpdesk'][15].":</td><td>";
		Profile::dropdownNoneReadWrite("resting",$this->fields["resting"],1,0,1);
		echo "</td>";


		echo "<td>".$LANG['plugin_resources']['helpdesk'][25].":</td><td>";
      ...
      echo "<th colspan='4' class='center b'>".$LANG['plugin_resources']['profile'][3]."</th>";

      echo "</tr>";

      echo "<tr class='tab_bg_2'>";

      echo "<td>".$LANG['plugin_resources']['helpdesk'][27].":</td><td>";
      Profile::dropdownNoneReadWrite("employment",$this->fields["employment"],1,1,1);
      echo "</td>";

      echo "<td>".$LANG['plugin_resources']['helpdesk'][28].":</td><td>";
      ...
      echo "<td>".$LANG['plugin_resources']['helpdesk'][31].":</td><td>";
