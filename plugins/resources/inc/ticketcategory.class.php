...
class PluginResourcesTicketCategory extends CommonDBTM {
   ...
   function showForm($target) {
      ...
      if (!empty($categories)) {
         ...
         echo "<tr>";
         echo "<th></th><th>".$LANG['plugin_resources']['checklists'][15]."</th>";
         echo "</tr>";
         foreach ($categories as $categorie) {
            ...
            echo "</td>";
            echo "<td>".Dropdown::getDropdownName("glpi_itilcategories",
                                                      $categorie["ticketcategories_id"])."</td>";
            echo "</tr>";
         }

         Html::openArrowMassives("massiveaction_form_ticket$rand", true);
         Html::closeArrowMassives(array('delete_ticket' => $LANG['buttons'][6]));
         ...
         echo $LANG['plugin_resources']['checklists'][15]." : </th></tr>";
         echo "<tr class='tab_bg_1'><td>";
         Dropdown::show('ITILCategory', array('name' => "ticketcategories_id"));
         echo "</td>";
         echo "<td>";
         echo "<div align='center'>";
         echo "<input type='submit' name='add_ticket' value=\"".$LANG['buttons'][2]."\" 
                                                                                 class='submit'>";
         echo "</div></td></tr>";
         echo "</table>";
         Html::closeForm();
