...
class PluginResourcesRuleChecklist extends Rule {
   ...
   function getTitle() {
      ...
      return $LANG['plugin_resources']['title'][0]." - ".$LANG['plugin_resources']['title'][3];
   }
   ...
   function getCriterias() {
      ...
      $criterias['checklist_type']['name']  = $LANG['plugin_resources'][70];
   ...
   **/
   ...
   function getActions() {
      ...
      $actions['checklists_id']['name']  = $LANG['plugin_resources'][68];
