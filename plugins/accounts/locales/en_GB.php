...
$LANG['plugin_accounts'][6] = "Associated item(s)";
$LANG['plugin_accounts'][7] = "Name";
$LANG['plugin_accounts'][8] = "Associated account(s)";
$LANG['plugin_accounts'][9] = "State";
$LANG['plugin_accounts'][10] = "Comments";
...
$LANG['plugin_accounts']['upgrade'][1] = "1. Define the encryption key and create hash";
...
$LANG['plugin_accounts']['profile'][0] = "Rights management";
...
$LANG['plugin_accounts']['setup'][2] = "Type of account";
...
$LANG['plugin_accounts']['setup'][9] = "Associate";
$LANG['plugin_accounts']['setup'][10] = "Dissociate";
...
$LANG['plugin_accounts']['setup'][20] = "Add a unused status <br> for expiration mailing";
