...
class PluginAccountsNotificationState extends CommonDBTM {
	...
	function getFromDBbyState($plugin_accounts_accountstates_id) {
		global $DB;
   ...
   function addNotificationState($plugin_accounts_accountstates_id) {
   ...
   function showAddForm($target) {
      ...
      echo $LANG['plugin_accounts']['setup'][20]." : </th></tr>";
   ...
   function showForm($target) {
      ...
      if ($result = $DB->query($query)) {
         ...
         if ($number != 0) {
            ...
            echo "<tr>";
            echo "<th></th><th>".$LANG['plugin_accounts']['setup'][19]."</th>";
            echo "</tr>";
