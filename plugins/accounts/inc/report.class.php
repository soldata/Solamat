...
class PluginAccountsReport extends CommonDBTM {
   ...
   static function queryAccountsList($values) {
      global $DB;
	...
	static function showAccountsList($values, $list) {
      ...
      echo Search::showHeaderItem($output_type,$LANG['plugin_accounts']['upgrade'][4],$header_num);
      if (Session::isMultiEntitiesMode())
         echo Search::showHeaderItem($output_type,$LANG['entity'][0],$header_num);
      echo Search::showHeaderItem($output_type, $LANG['plugin_accounts'][12], $header_num);
      echo Search::showHeaderItem($output_type,$LANG['plugin_accounts'][2],$header_num);
      echo Search::showHeaderItem($output_type,$LANG['plugin_accounts']['upgrade'][5],$header_num);
      ...
      // Display footer
      echo Search::showFooter($output_type,$LANG['plugin_accounts'][11]);
   }
