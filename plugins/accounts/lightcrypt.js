...
function callAjax(root,idcrypt,nameP) {
   if (id.length==0) {
      document.getElementByName("hidden_password").innerHTML=""
      return
   }
   ...
   var url=root+"/plugins/accounts/front/account.form.php"
...
function stateChanged(){
   if (xmlHttp.readyState==4 || xmlHttp.readyState=="complete") {
      document.getElementByName("hidden_password").innerHTML=xmlHttp.responseText
   }
}
