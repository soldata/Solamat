...
class PluginPositionsInfo extends CommonDBTM {
   ...
   public $dohistory=true;
	...
	static function getTypeName() {
      ...
      return $LANG['plugin_positions']['info'][0];
   }
   ...
   function getSearchOptions() {
      ...
      $tab[3]['field']         = 'fields';
      $tab[3]['name']          = $LANG['plugin_positions']['info'][2];
      $tab[3]['massiveaction'] = false;

      $tab[4]['table']         = $this->getTable();
      $tab[4]['field']         = 'itemtype';
      $tab[4]['name']          = $LANG['plugin_positions']['info'][1];
      ...
      $tab[5]['name']          = $LANG['plugin_positions']['info'][3];
      $tab[5]['datatype']      = 'bool';
   ...
   function showForm ($ID, $options=array()) {
      ...
      echo "</td></tr>";
		...
		echo "<tr class='tab_bg_1'><td>".$LANG['plugin_positions']['info'][1]."&nbsp;:</td>";
		echo "<td>";
      ...
      $this->showItemtype($ID, $this->fields['itemtype']);
		...
		echo "<tr class='tab_bg_1'><td>".$LANG['plugin_positions']['info'][2]."&nbsp;:</td>";
		echo "<td>";	
   ...
   **/
   ...
   static function getFieldsValue($searchOption,$field,$itemclass) {
      ...
      if ($type == 'dropdown') {
         ...
         echo "<img src='".GLPI_ROOT."/plugins/positions/pics/miniphones.png' title='".
         $display."'>&nbsp;
         <a href=\"tel:".$display."\">".
         $display."</a>";
   ...
   static function getDirectLink($itemclass) {
      ...
      if (isset($itemclass->fields["name"]) 
         && !empty($itemclass->fields["name"]) && $itemclass->getType() != 'Location' ) {
         echo "<h3>".$LANG['plugin_positions'][13]." : ";
      ...
      switch ($itemclass->getType()) {
         case 'Phone' :
            if (isset($itemclass->fields['contact_num']) 
               ...
               if (!$export) {
                  echo "<span class='title'>".$LANG['common'][21]." : </span>";
                  echo "<img src='".GLPI_ROOT."/plugins/positions/pics/miniphones.png' title='".
                  $contact_num."'>&nbsp;
                  <a href=\"tel:".$contact_num."\">".
                  $contact_num."</a>&nbsp;&nbsp;&nbsp;&nbsp;";
               } else {
                   $display.="\n".$LANG['common'][21]." : ".$contact_num;
               }
            }
            if (isset($itemclass->fields['number_line']) 
               ...
               if (!$export) {
                  echo "<span class='title'>".$LANG['phones'][40]." : </span>";
                  echo "<img src='".GLPI_ROOT."/plugins/positions/pics/miniphones.png' title='".
                  $directline."'>&nbsp;
                  <a href=\"tel:".$directline."\">".
                  $directline."</a>";
               } else {
                  $display.="\n".$LANG['phones'][40]." : ".$directline;
               }
            }
            if ($export) {
               return $display;
