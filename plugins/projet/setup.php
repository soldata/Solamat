   ...
   if (Session::getLoginUserID()) {
      ...
      Plugin::registerClass('PluginProjetProfile',
		...
		if (plugin_projet_haveRight("task","r")) {
         ...
         $LANG['plugin_projet'][68]."' alt='".$LANG['plugin_projet'][68]."'>"] = 'front/task.php';
...
function plugin_version_projet() {
	...
	return array (
		'name' => $LANG['plugin_projet']['title'][4],
		'version' => '1.3.2',
		'license' => 'GPLv2+',
		'author'  => "<a href='http://www.infotel.com/fr/services_glpi.html'>Infotel</a> & <a href='mailto:d.durieux@siprossii.com'>David DURIEUX</a>",
