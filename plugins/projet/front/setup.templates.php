...
if($PluginProjetProjet->canView() || Session::haveRight("config","w")) {

	Html::header($LANG['plugin_projet']['title'][1],'',"plugins","projet");
	
   $PluginProjetProjet->listOfTemplates($CFG_GLPI["root_doc"]."/plugins/projet/front/projet.form.php",$_GET["add"]);
