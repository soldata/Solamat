...
$LANG['plugin_formcreator']["question"][1] = "Ajouter une nouvelle question";
$LANG['plugin_formcreator']["question"][2] = "Question";
$LANG['plugin_formcreator']["question"][3] = "Laisser vide si aucune valeur par défaut.";
$LANG['plugin_formcreator']["question"][5] = "Libellé par défaut";
$LANG['plugin_formcreator']["question"][6] = "Nouvelle valeur";
$LANG['plugin_formcreator']["question"][7] = "Nouvelle question";
$LANG['plugin_formcreator']["question"][8] = "Editer la question";
$LANG['plugin_formcreator']["question"][9] = "Vous devez d'abord créer une section pour";
$LANG['plugin_formcreator']["question"][9].= " pouvoir ajouter une question.";
...
$LANG['plugin_formcreator']["headings"][2] = "Section(s) de question(s)";
$LANG['plugin_formcreator']["headings"][3] = "Question(s)";
...
$LANG['plugin_formcreator']["target"][1] = "Nouveau ticket cible";
$LANG['plugin_formcreator']["target"][2] = "Tickets cibles";
$LANG['plugin_formcreator']["target"][3] = "Paramètre du ticket";
$LANG['plugin_formcreator']["target"][4] = "Titre du ticket";
$LANG['plugin_formcreator']["target"][5] = "Modifier un ticket cible";
