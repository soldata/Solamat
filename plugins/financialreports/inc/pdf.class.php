...
/**
	...
	function Header() {
      ...
      $this->Cell($largeur_titre, $this->line_height * 2, Toolbox::decodeFromUtf8($LANG['plugin_financialreports']['reports'][1]), 'LTR', 0, 'C');
	...
	function affiche_tableau($total,$items,$deviceType,$disposal=0) {
		global $LANG;
		 ...
		 if ($total!=0) {
			...
			/* En tete tableau. */
			$this->CellEnTeteTableau(false, 45, Toolbox::decodeFromUtf8($LANG['plugin_financialreports']['reports'][2]),1,'C',1);
			$this->CellEnTeteTableau(false, 35, Toolbox::decodeFromUtf8($LANG['plugin_financialreports']['reports'][3]),1,'C',1);
			$this->CellEnTeteTableau(false, 20, Toolbox::decodeFromUtf8($LANG['plugin_financialreports']['reports'][4]),1,'C',1);
			if ($disposal!=1) {
				$this->CellEnTeteTableau(false, 40, Toolbox::decodeFromUtf8($LANG['plugin_financialreports']['reports'][5]),1,'C',1);
				$this->CellEnTeteTableau(false, 40, Toolbox::decodeFromUtf8($LANG['plugin_financialreports']['reports'][12]),1,'C',1);
			}
			$this->CellEnTeteTableau(false, 40, Toolbox::decodeFromUtf8($LANG['plugin_financialreports']['reports'][6]),1,'C',1);
			$this->CellEnTeteTableau(false, 40, Toolbox::decodeFromUtf8($LANG['plugin_financialreports']['reports'][7]),1,'C',1);

			if ($disposal==1) {
				$this->CellEnTeteTableau(false, 20, Toolbox::decodeFromUtf8($LANG['plugin_financialreports']['reports'][18]),1,'C',1);
				$this->CellEnTeteTableau(false, 25, Toolbox::decodeFromUtf8($LANG['plugin_financialreports']['reports'][17]),1,'C',1);
				$this->CellEnTeteTableau(false, 55, Toolbox::decodeFromUtf8($LANG['common'][25]),1,'C',1);
			} else {
				$this->CellEnTeteTableau(false, 20, Toolbox::decodeFromUtf8($LANG['plugin_financialreports']['reports'][18]),1,'C',1);
			}
			$this->SetY($this->GetY() + $this->line_height);
			...
			/* pied */
			if ($total!=-1) {
				$this->CellEnTeteTableau(true, $this->largeur_grande_cell-20 , Toolbox::decodeFromUtf8($LANG['plugin_financialreports']['reports'][9]),1,'R',1);
				$this->SetTextRouge();
...
/**
	...
	function affiche_tableau_fin($total) {
      ...
      $this->SetY($this->GetY() + $this->line_height);
      /* en-tete */
      $this->CellLabel(false, $this->largeur_grande_cell ,Toolbox::decodeFromUtf8($LANG['plugin_financialreports']['reports'][10]));
      $this->SetY($this->GetY() + $this->line_height);

      $this->CellEnTeteTableau(true, $this->largeur_grande_cell-25 , Toolbox::decodeFromUtf8($LANG['plugin_financialreports']['reports'][9]),1,'R',1);
      $this->SetTextRouge();
