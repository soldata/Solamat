...
class PluginFinancialreportsProfile extends CommonDBTM {
	...
	static function getTypeName() {
      ...
      return $LANG['plugin_financialreports']['profile'][0];
   }
   ...
   static function displayTabContentForItem(CommonGLPI $item, $tabnum=1, $withtemplate=0) {
	...
	function showForm ($ID, $options=array()) {
      ...
      $this->showFormHeader($options);
		...
		echo "<th colspan='2'>".$LANG['plugin_financialreports']['profile'][0]." ".$prof->fields["name"]."</th>";
		
		echo "<td>".$LANG['plugin_financialreports']['profile'][3].":</td><td>";
