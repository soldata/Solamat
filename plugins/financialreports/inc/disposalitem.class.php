...
class PluginFinancialreportsDisposalItem extends CommonDBTM {
	...
	static function getTypeName() {
      ...
      return $LANG['plugin_financialreports']['reports'][17];
   }
   ...
   **/
   ...
   function getTabNameForItem(CommonGLPI $item, $withtemplate=0) {
      ...
      if (in_array($item->getType(), self::getTypes(true))
               && plugin_financialreports_haveRight("financialreports","r")) {

         return $LANG['plugin_financialreports']['title'][1];
      }
   ...
   function showForm($type,$device) {
      ...
      echo "<tr><th colspan='3'>".$LANG['plugin_financialreports']['title'][1]."</th></tr>";

      echo "<tr class='tab_bg_2'>";
      echo "<td class='left'>";
      echo $LANG['plugin_financialreports']['reports'][11]."</td><td class='left'>";
      if ($number ==1) {
         ...
         echo "</td>";
         echo "</tr>";
         echo "<tr><th colspan='3'><input type='hidden' name='items_id' value='".$device."'><input type='hidden' name='itemtype' value='".$type."'>";
         echo "<input type=\"submit\" name=\"add_date\" class=\"submit\" value=\"".$LANG['buttons'][2]."\" ></th></tr>";
      }
      echo "</table></div>";
      Html::closeForm();
   }
