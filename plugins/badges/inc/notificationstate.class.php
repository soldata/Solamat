...
class PluginBadgesNotificationState extends CommonDBTM {
	...
	function getFromDBbyState($states_id) {
		global $DB;
   ...
   function addNotificationState($states_id) {
   ...
   function showAddForm($target) {
      ...
      echo $LANG['plugin_badges']['setup'][20]." : </th></tr>";
   ...
   function showForm($target) {
      ...
      if ($result = $DB->query($query)) {
         ...
         if ($number != 0) {
            ...
            echo "<tr>";
            echo "<th></th><th>".$LANG['plugin_badges']['setup'][20]."</th>";
            echo "</tr>";
