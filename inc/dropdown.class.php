<?php
/*
 * @version $Id: dropdown.class.php 20130 2013-02-04 16:55:15Z moyo $
 -------------------------------------------------------------------------
...
class Dropdown {
    ...
    *
   **/
	 static function listeEnt($itemtype, $options=array()) {
      ...
      $default  = "<select name='ent' id='dropdown_".$params['name'].
                    $params['rand']."'>";
