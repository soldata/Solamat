<?php
/*
 * @version $Id: html.class.php 20713 2013-04-12 10:10:43Z yllen $
 -------------------------------------------------------------------------
...
class Html {
   ...
   **/
   static function includeHeader($title='') {
      ...
      echo "\n<html><head><title>SolaMat - ".$title."</title>";
...
//             $LANG['bookmark'][1]."\"  alt=\"".$LANG['buttons'][52]." ".$LANG['bookmark'][1]."\">";
   ...
   **/
   static function footer($keepDB=false) {
	  ...
	  echo "<img alt='Sol@Mat' title='Sol@Mat' src='/pics/logoFooter.png'>";
      ...
      echo "<td class='right'>";
      echo "<span class='copyright'> Copyright (C) 2003-".date("Y")." by the INDEPNET.</span>";
      echo "</a></td>";
      echo "</tr></table></div>";
   ...
   **/
    ...
    * @return nothing (print out an HTML div)
   **/
 	  static function champsCalendar(CommonDBTM $item, $field, $options=array(), $maybeempty=true, $can_edit=true, $displayYear=true) {
      global $CFG_GLPI;
